...
(defmacro !eq?
  ...
  "strings not equal?" [a b] `(not (.equals ~a ~b)))
...
(defmacro vtbl*
  ...
  "Make a virtual table:
  op1 f1 op2 f2." [& args] `(vtbl** nil ~@args))
...
(defn kvs->map
  ...
  [args]
  {:pre [(even? (count args))]} (apply array-map args))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defprotocol Versioned (version [_] ""))
